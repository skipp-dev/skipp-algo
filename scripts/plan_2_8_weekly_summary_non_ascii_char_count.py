...
Count of code points in the summary with ord > 127.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Non-ascii char count.")
