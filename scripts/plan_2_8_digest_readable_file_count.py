...
Counts top-level regular files whose read bit is set for
the current process.
"""
...
def render_markdown(report: dict[str, Any]) -> str:
    return (
        ...
        f"- readable_file_count: {report['readable_file_count']}\n"
    )


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Readable-file count.")
