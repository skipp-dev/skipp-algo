...
def compute(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "bool_or_string_or_null_record_count":  n,
    }
...
def render_markdown(report: dict[str, Any]) -> str:
    return (
        ...
        "- bool_or_string_or_null_record_count: "
        f"{report['bool_or_string_or_null_record_count']}\n"
    )


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Bool-or-string-or-null record count.",
    )
