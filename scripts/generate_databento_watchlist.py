...
def expand_candidate_trade_plan(candidates: pd.DataFrame, cfg: LongDipConfig) -> pd.DataFrame:
    ...
    for _, row in candidates.iterrows():
        base = {
            ...
            "focus_0930_open_30s_volume": row.get("focus_0930_open_30s_volume"),
            "focus_0930_early_dip_pct_10s": row.get("focus_0930_early_dip_pct_10s"),
            "focus_0930_reclaim_second_30s": row.get("focus_0930_reclaim_second_30s"),
