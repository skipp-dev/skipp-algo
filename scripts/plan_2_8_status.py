...
PHASES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "anchors": [
            ...
            ("required", "scripts/plan_2_8_digest_non_empty_file_count.py"),
            ("required", "tests/test_plan_2_8_digest_non_empty_file_count.py"),
            ("required", "scripts/plan_2_8_weekly_summary_blank_line_count.py"),
            ("required", "tests/test_plan_2_8_weekly_summary_blank_line_count.py"),
