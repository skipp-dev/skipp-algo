...
def compute(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "string_or_float_only_record_count": n,
    }
...
def render_markdown(report: dict[str, Any]) -> str:
    return (
        ...
        "- string_or_float_only_record_count: "
        f"{report['string_or_float_only_record_count']}\n"
    )


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="String-or-float-only record count.",
    )
