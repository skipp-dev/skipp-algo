"""Plan 2.8 ledger shortest-run summary.

Reports the shortest consecutive same-status run length.
Empty ledger yields ``min_length: 0``.
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Shortest run length.")
