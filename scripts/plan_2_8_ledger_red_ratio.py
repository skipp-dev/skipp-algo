"""Plan 2.8 ledger red ratio.

Mirror of the green/amber ratio helpers for red records.
Reports the share of red records within the trailing N
entries; ``ratio`` is ``None`` for an empty window;
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Red share over the last N ledger records.",
    )
