"""Plan 2.8 first-flip extractor.

Scans the status ledger for the earliest status transition
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Report the earliest status flip in the ledger.",
    )
