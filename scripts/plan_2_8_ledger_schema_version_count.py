"""Plan 2.8 ledger schema version count."""
...
def compute(records: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "schema_version_count":             len(versions),
    }
...
def render_markdown(report: dict[str, Any]) -> str:
    return (
        ...
        f"- schema_version_count: {report['schema_version_count']}\n"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Schema version count.")
