"""Plan 2.8 ledger last observation timestamp.

Returns the raw ``captured_at`` string of the last valid
...
def render_markdown(report: dict[str, Any]) -> str:
    return (
        "# Plan 2.8 ledger last observation\n"
        "\n"
        f"- last_captured_at: {report['last_captured_at'] or '(none)'}\n"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Last observation.")
