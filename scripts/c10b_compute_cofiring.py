...
(OUT_DIR / "co_firing_matrix.json").write_text(json.dumps(cofiring_payload, indent=2, default=str))
(OUT_DIR / "cramers_v_pairwise.json").write_text(json.dumps(cramers_payload, indent=2, default=str))
