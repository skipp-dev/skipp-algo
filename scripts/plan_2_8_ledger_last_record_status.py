"""Plan 2.8 ledger last record status."""
...
def render_markdown(report: dict[str, Any]) -> str:
    return (
        ...
        f"- last_record_status: {report['last_record_status']}\n"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Last record status.")
