...
def _is_us_equity_trading_day(d: date) -> bool:
    ...
    # generated by _us_equity_market_holidays(d.year + 1), not d.year.
    if d.month == 12 and d in _us_equity_market_holidays(d.year + 1):
        return False
    return True
    ...
    *progress_callback*, when provided, is called as ``callback(stage, total)``
    ...
    for q in quotes:
        ...
        if pm:
            ...
            q["premarket_freshness_sec"] = pm.get("premarket_freshness_sec")
