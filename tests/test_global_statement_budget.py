...
_FROZEN_SITES: frozenset[tuple[str, int, tuple[str, ...]]] = frozenset(
    {
        ...
        ("services/live_overlay_daemon/compute.py", 256, ("_news_cache", "_news_checked_at", "_news_loaded_at")),
        ...
        ("services/live_overlay_daemon/compute.py", 405, ("_signals_cache", "_signals_checked_at", "_signals_loaded_at")),
        # 2026-06-23 (feat/grafana-tv-credential-age): credential-health report
        # loader mirrors the same snapshot caching pattern.
        # 2026-06-26 (PR #2962): shifted by producer client code.
        ("services/live_overlay_daemon/compute.py", 492, ("_tradingview_credential_cache", "_tradingview_credential_checked_at", "_tradingview_credential_loaded_at")),
        ...
        # 2026-06-26 (PR #2962): shifted by producer client code.
        ("services/live_overlay_daemon/compute.py", 611, ("_experiment_cache", "_experiment_checked_at", "_experiment_loaded_at")),
        ("services/live_overlay_daemon/compute.py", 659, ("_experiment_history_cache", "_experiment_history_checked_at", "_experiment_history_loaded_at")),
