...
_FROZEN_SITES: frozenset[tuple[str, int, tuple[str, ...]]] = frozenset(
    {
        ...
        # 2026-06-23: workflow status/conclusion semantics hardening added
        # inline field docs in _fetch_snapshot(), shifting global anchor 180→185.
        ("services/live_overlay_daemon/github_workflow_bridge.py", 185, ("_cached_at_monotonic", "_cached_snapshot")),
