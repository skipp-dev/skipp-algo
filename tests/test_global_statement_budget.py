...
_FROZEN_SITES: frozenset[tuple[str, int, tuple[str, ...]]] = frozenset(
    {
        ...
        ("open_prep/regime.py", 121, ("_prev_regime",)),
        ("open_prep/regime.py", 147, ("_prev_regime",)),
        ...
        ("terminal_databento.py", 90, ("_quote_cache", "_quote_cache_ts")),
        ("terminal_databento.py", 208, ("_dataset_cache",)),
        ("terminal_finnhub.py", 172, ("_consecutive_429_count", "_rate_limit_backoff_until")),
        ("terminal_finnhub.py", 197, ("_social_sentiment_blocked",)),
