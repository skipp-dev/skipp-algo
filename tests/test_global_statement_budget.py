...
_FROZEN_SITES: frozenset[tuple[str, int, tuple[str, ...]]] = frozenset(
    {
        ...
        ("newsstack_fmp/pipeline.py", 100, ("_bz_ws_adapter", "_bz_ws_adapter_key")),
        ("newsstack_fmp/pipeline.py", 126, ("_enricher",)),
        ("newsstack_fmp/pipeline.py", 774, ("_last_meta",)),
        (
        ...
        ("terminal_databento.py", 124, ("_quote_cache", "_quote_cache_ts")),
        ("terminal_databento.py", 308, ("_dataset_cache",)),
