...
_FROZEN_JSON_LOAD_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("open_prep/realtime_signals.py", 1600),
        ("open_prep/realtime_signals.py", 2737),
...
_FROZEN_ENV_SUBSCRIPT_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("open_prep/realtime_signals.py", 2777),  # BUG-3 fix: auth_token removed from closure; _load_env_file os.environ[key] shifted
