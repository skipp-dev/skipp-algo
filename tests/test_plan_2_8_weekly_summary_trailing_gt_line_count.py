"""Tests for ``plan_2_8_weekly_summary_trailing_gt_line_count.py``."""
...
NAME = "plan_2_8_weekly_summary_trailing_gt_line_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "trailing_gt_line_count"
NM = "Plan 2.8 weekly summary trailing gt line count"
...
def test_weekly_has_tgt_steps() -> None:
