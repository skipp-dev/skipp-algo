"""Tests for ``plan_2_8_weekly_summary_leading_ampersand_line_count.py``."""
...
NAME = "plan_2_8_weekly_summary_leading_ampersand_line_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "leading_ampersand_line_count"
NM = "Plan 2.8 weekly summary leading ampersand line count"
...
def test_weekly_has_lamp_steps() -> None:
