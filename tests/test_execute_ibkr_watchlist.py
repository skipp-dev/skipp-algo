...
def test_build_tp_trail_orders_sets_oca_group_and_anchor() -> None:
    class FakeClient:
        ...
        def getReqId(self) -> int:  # noqa: N802 - mirrors ib_insync IB.client API
            value = self._next_id
            self._next_id += 1
            return value
...
def test_monitor_open_orders_returns_filtered_snapshot() -> None:
    ...
    class FakeIB:
        def openTrades(self):  # noqa: N802 - mirrors ib_insync IB API
            return [
...
def test_supervise_open_execution_recovers_from_initial_disconnect() -> None:
    class FakeIB:
        ...
        def isConnected(self) -> bool:  # noqa: N802 - mirrors ib_insync IB API
