...
class _FakeIB:
    ...
    def isConnected(self):  # noqa: N802 -- mocks IBKR API (camelCase required)
...
class TestPlaceOrderIntentsWithIb:
    ...
    def test_tp_trail_uses_build_tp_trail_orders(self):
        ...
        def LimitOrder(action, qty, price):  # noqa: N802 -- mocks IBKR API (camelCase required)
        ...
        def Order(**kw):  # noqa: N802 -- mocks IBKR API (camelCase required)
            return SimpleNamespace(
