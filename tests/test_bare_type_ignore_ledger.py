...
_FROZEN_BARE_TYPE_IGNORE_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        # Was 137 before PR #382 (Copilot review fixes); shifted to 156
        # by the explicit ``mark_endpoint_disabled(label)`` block + comment.
        ("newsstack_fmp/_bz_http.py", 156),
        ("terminal_bitcoin.py", 310),
        ("terminal_bitcoin.py", 394),
        ("terminal_bitcoin.py", 477),
        ("terminal_bitcoin.py", 482),
        ("terminal_bitcoin.py", 537),
        ("terminal_bitcoin.py", 551),
        ("terminal_bitcoin.py", 555),
        ("terminal_bitcoin.py", 564),
        ("terminal_bitcoin.py", 642),
        ("terminal_bitcoin.py", 714),
        ("terminal_bitcoin.py", 756),
        ("terminal_bitcoin.py", 781),
        ("terminal_bitcoin.py", 807),
        ("terminal_bitcoin.py", 860),
    }
)
