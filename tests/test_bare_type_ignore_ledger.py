...
_FROZEN_BARE_TYPE_IGNORE_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("terminal_bitcoin.py", 484),
        ("terminal_bitcoin.py", 539),
        ("terminal_bitcoin.py", 553),
        ("terminal_bitcoin.py", 557),
        ("terminal_bitcoin.py", 566),
        ("terminal_bitcoin.py", 644),
        ("terminal_bitcoin.py", 699),
        ("terminal_bitcoin.py", 741),
        ("terminal_bitcoin.py", 766),
        ("terminal_bitcoin.py", 792),
        ("terminal_bitcoin.py", 845),
    }
)
