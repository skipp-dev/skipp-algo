...
_TEMPFILE_LEDGER: frozenset[tuple[str, int, str]] = frozenset({
    ...
    ("databento_volatility_screener.py", 298, "mkstemp"),
    ...
    ("open_prep/outcomes.py", 95, "mkstemp"),
    ("open_prep/outcomes.py", 363, "mkstemp"),
    ("open_prep/realtime_signals.py", 109, "mkstemp"),
    ("open_prep/realtime_signals.py", 2495, "mkstemp"),
    ("open_prep/realtime_signals.py", 2536, "mkstemp"),
