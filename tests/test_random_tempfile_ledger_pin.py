...
_TEMPFILE_LEDGER: frozenset[tuple[str, int, str]] = frozenset({
    ...
    ("databento_volatility_screener.py", 373, "mkstemp"),
    ...
    ("open_prep/feature_importance_report.py", 248, "mkstemp"),
    ...
    ("terminal_export.py", 173, "mkstemp"),
    ("terminal_export.py", 225, "mkstemp"),
    ("terminal_export.py", 602, "mkstemp"),
    ("terminal_export.py", 746, "mkstemp"),
})
