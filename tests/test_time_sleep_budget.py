...
_FROZEN_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ("newsstack_fmp/_bz_http.py", 133),
        ("newsstack_fmp/_bz_http.py", 148),
        ("newsstack_fmp/ingest_benzinga.py", 196),
        ("newsstack_fmp/ingest_benzinga.py", 207),
        ("newsstack_fmp/ingest_fmp.py", 91),
        ("newsstack_fmp/ingest_fmp.py", 109),
        ...
        ("open_prep/macro.py", 565),
        ("open_prep/macro.py", 578),
        ("open_prep/realtime_signals.py", 265),
        ("open_prep/realtime_signals.py", 338),
        ("open_prep/realtime_signals.py", 1590),
        ("open_prep/realtime_signals.py", 2691),
        ("open_prep/realtime_signals.py", 2704),
        ("open_prep/run_open_prep.py", 1695),
        ("open_prep/run_open_prep.py", 1697),
