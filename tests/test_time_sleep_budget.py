...
_FROZEN_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("newsstack_fmp/ingest_fmp_filings.py", 106),
        ("newsstack_fmp/ingest_fmp_filings.py", 119),
        ("newsstack_fmp/ingest_fmp_political.py", 108),
        ("newsstack_fmp/ingest_fmp_political.py", 121),
        ("newsstack_fmp/pipeline.py", 1135),
