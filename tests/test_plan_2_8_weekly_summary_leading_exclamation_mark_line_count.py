"""Tests for ``plan_2_8_weekly_summary_leading_exclamation_mark_line_count.py``."""
...
NAME = "plan_2_8_weekly_summary_leading_exclamation_mark_line_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "leading_exclamation_mark_line_count"
NM = "Plan 2.8 weekly summary leading exclamation mark line count"
...
def test_weekly_has_lex_steps() -> None:
