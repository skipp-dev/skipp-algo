...
DELETED_FIELDS: set[str] = {
    ...
    "POOL_QUALITY_SCORE",
    # Order Blocks (v5.2) — all 13 removed (WP-8 sunsetted remaining 9 re-exports)
    "OB_DENSITY",
    ...
    "SESS_PDL_SWEPT",
    "SESS_STRUCT_SCORE",
    # Range Regime (v5.3) — all 11 removed (WP-8)
    "RANGE_REGIME",
    "RANGE_WIDTH_PCT",
    "RANGE_POSITION",
    "RANGE_HIGH",
    ...
    "RANGE_BALANCE_STATE",
    "RANGE_REGIME_SCORE",
    # Range Profile Regime (v5.3) — all 22 removed (WP-8)
    "RANGE_ACTIVE",
    "RANGE_TOP",
    "RANGE_BOTTOM",
    "RANGE_MID",
