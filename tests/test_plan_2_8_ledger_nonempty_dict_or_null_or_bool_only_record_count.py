"""Tests for ``plan_2_8_ledger_nonempty_dict_or_null_or_bool_only_record_count.py``."""
...
NAME = "plan_2_8_ledger_nonempty_dict_or_null_or_bool_only_record_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "nonempty_dict_or_null_or_bool_only_record_count"
NM = "Plan 2.8 ledger nonempty dict or null or bool only record count"
...
def test_weekly_has_ndnb_steps() -> None:
