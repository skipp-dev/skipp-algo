...
_FROZEN_SITES: frozenset[tuple[str, int, tuple[str, ...]]] = frozenset(
    {
        ("databento_volatility_screener.py", 4687, ("_fast_progress_pct",)),
        ("databento_volatility_screener.py", 4688, ("_fast_progress_step",)),
        ("databento_volatility_screener.py", 4689, ("_fast_progress_total",)),
        ("databento_volatility_screener.py", 4690, ("_fast_eta_smooth_seconds",)),
