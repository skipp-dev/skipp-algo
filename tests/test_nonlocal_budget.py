...
_FROZEN_SITES: frozenset[tuple[str, int, tuple[str, ...]]] = frozenset(
    {
        ("databento_volatility_screener.py", 4678, ("_fast_progress_pct",)),
        ("databento_volatility_screener.py", 4679, ("_fast_progress_step",)),
        ("databento_volatility_screener.py", 4680, ("_fast_progress_total",)),
        ("databento_volatility_screener.py", 4681, ("_fast_eta_smooth_seconds",)),
