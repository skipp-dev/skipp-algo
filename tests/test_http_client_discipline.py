...
_FROZEN_URLOPEN_SITES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        # 2026-06-23: live-overlay daemon optional runtime fetches for
        # NEWS_SNAPSHOT_URL and SIGNALS_SNAPSHOT_URL (https-only, explicit
        # timeout) with local-file fallback.
