"""Tests for ``plan_2_8_weekly_summary_trailing_semicolon_line_count.py``."""
...
NAME = "plan_2_8_weekly_summary_trailing_semicolon_line_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "trailing_semicolon_line_count"
NM = "Plan 2.8 weekly summary trailing semicolon line count"
...
def test_weekly_has_tsc_steps() -> None:
