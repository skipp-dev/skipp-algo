"""Tests for ``plan_2_8_ledger_dict_or_list_or_bool_only_record_count.py``."""
...
NAME = "plan_2_8_ledger_dict_or_list_or_bool_only_record_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "dict_or_list_or_bool_only_record_count"
NM = "Plan 2.8 ledger dict or list or bool only record count"
...
def test_weekly_has_dlb_steps() -> None:
