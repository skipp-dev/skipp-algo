"""Tests for ``plan_2_8_ledger_bool_or_list_or_null_only_record_count.py``."""
...
NAME = "plan_2_8_ledger_bool_or_list_or_null_only_record_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "bool_or_list_or_null_only_record_count"
NM = "Plan 2.8 ledger bool or list or null only record count"
...
def test_weekly_has_bln_steps() -> None:
