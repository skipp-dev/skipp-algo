...
OS_DELETE_LEDGER: set[tuple[str, int, str]] = {
    ...
    ("open_prep/outcomes.py", 129, "unlink"),
    ("open_prep/outcomes.py", 409, "unlink"),
    ("open_prep/realtime_signals.py", 117, "remove"),
    ("open_prep/realtime_signals.py", 2514, "unlink"),
    ("open_prep/realtime_signals.py", 2553, "unlink"),
    ("open_prep/run_open_prep.py", 2213, "unlink"),
    ("open_prep/run_open_prep.py", 3017, "unlink"),
    ("open_prep/run_open_prep.py", 3361, "unlink"),
    ("open_prep/run_open_prep.py", 5655, "unlink"),
    ("open_prep/scorer.py", 114, "unlink"),
    ("open_prep/watchlist.py", 74, "unlink"),
    ("terminal_export.py", 179, "unlink"),
    ("terminal_export.py", 231, "unlink"),
    ("terminal_export.py", 619, "unlink"),
    ("terminal_export.py", 762, "unlink"),
}
