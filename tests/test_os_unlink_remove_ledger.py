...
OS_DELETE_LEDGER: set[tuple[str, int, str]] = {
    ...
    ("open_prep/outcome_backfill.py", 521, "unlink"),
    ("open_prep/outcomes.py", 129, "unlink"),
    ("open_prep/outcomes.py", 409, "unlink"),
    ("open_prep/realtime_signals.py", 117, "remove"),
    ("open_prep/realtime_signals.py", 2513, "unlink"),
    ("open_prep/realtime_signals.py", 2552, "unlink"),
    ("open_prep/run_open_prep.py", 2218, "unlink"),
    ("open_prep/run_open_prep.py", 3019, "unlink"),
    ("open_prep/run_open_prep.py", 3357, "unlink"),
    ("open_prep/run_open_prep.py", 5651, "unlink"),
    ("open_prep/scorer.py", 114, "unlink"),
    ("open_prep/watchlist.py", 74, "unlink"),
    ("terminal_export.py", 177, "unlink"),
    ("terminal_export.py", 229, "unlink"),
    ("terminal_export.py", 617, "unlink"),
    ("terminal_export.py", 760, "unlink"),
}
