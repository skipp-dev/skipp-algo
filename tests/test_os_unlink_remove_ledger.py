...
OS_DELETE_LEDGER: set[tuple[str, int, str]] = {
    ...
    ("newsstack_fmp/store_sqlite.py", 141, "remove"),
    ...
    ("open_prep/outcome_backfill.py", 522, "unlink"),
    ("open_prep/outcomes.py", 104, "unlink"),
    ("open_prep/outcomes.py", 375, "unlink"),
    ("open_prep/realtime_signals.py", 117, "remove"),
    ("open_prep/realtime_signals.py", 2511, "unlink"),
    ("open_prep/realtime_signals.py", 2550, "unlink"),
    ("open_prep/run_open_prep.py", 1966, "unlink"),
    ("open_prep/run_open_prep.py", 2770, "unlink"),
    ("open_prep/run_open_prep.py", 3114, "unlink"),
    ("open_prep/run_open_prep.py", 5332, "unlink"),
    ("open_prep/scorer.py", 114, "unlink"),
    ("open_prep/watchlist.py", 74, "unlink"),
    ("terminal_export.py", 132, "unlink"),
    ("terminal_export.py", 184, "unlink"),
    ("terminal_export.py", 572, "unlink"),
    ("terminal_export.py", 715, "unlink"),
}
