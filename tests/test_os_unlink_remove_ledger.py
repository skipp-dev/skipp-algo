...
OS_DELETE_LEDGER: set[tuple[str, int, str]] = {
    ...
    ("open_prep/realtime_signals.py", 2674, "unlink"),  # 2026-06-24: +1 shift from TELEMETRY_BIND_HOST default change
    ("open_prep/realtime_signals.py", 2713, "unlink"),  # 2026-06-24: +1 shift
