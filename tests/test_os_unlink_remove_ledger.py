...
OS_DELETE_LEDGER: set[tuple[str, int, str]] = {
    ...
    # parsed-date sorting edits shifted all run_open_prep sites by +9..+18.
    ...
    ("open_prep/run_open_prep.py", 3051, "unlink"),
    ("open_prep/run_open_prep.py", 3394, "unlink"),
    # 2026-06-11 (Copilot sweep #2688): VIX9D fail-closed guard +5;
    # 2026-06-12 (merge #2713 into #2696): net +1 → 5512/5790.
    ("open_prep/run_open_prep.py", 5530, "unlink"),
    ...
    ("open_prep/run_open_prep.py", 5820, "unlink"),
