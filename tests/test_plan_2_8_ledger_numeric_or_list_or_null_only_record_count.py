"""Tests for ``plan_2_8_ledger_numeric_or_list_or_null_only_record_count.py``."""
...
NAME = "plan_2_8_ledger_numeric_or_list_or_null_only_record_count"
SCRIPT = REPO / "scripts" / f"{NAME}.py"
WEEKLY = REPO / ".github" / "workflows" / "plan-2-8-weekly-digest.yml"
KEY = "numeric_or_list_or_null_only_record_count"
NM = "Plan 2.8 ledger numeric or list or null only record count"
...
def test_weekly_has_nln_steps() -> None:
